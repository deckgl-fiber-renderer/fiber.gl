...
_Why?_ `toBeTruthy`/`toBeFalsy` are too permissive. Be explicit about the expected value.
...
_Why?_ Test behavior, not implementation. Internal helpers can change without breaking public API.

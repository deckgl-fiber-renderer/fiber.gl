...
- **THEN** use `src/` with subdirectories following definitive-react.md import hierarchy: `data-access/` (client-side fetch functions), `utils/`, `hooks/`, `stores/`, `modules/`, `features/` (single-file), `components/`

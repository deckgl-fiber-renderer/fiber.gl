...
describe("DataService", () => {
  ...
  it("should fail after max retries", async () => {
    ...
    await expect(service.fetchWithRetry("/api/data")).rejects.toThrow(
...
describe("UserRepository", () => {
  it("should handle database connection errors", async () => {
    ...
    await expect(repo.findById("user-123")).rejects.toThrow(
...
describe("processUser", () => {
  ...
  it("should handle undefined user", () => {
    expect(() => processUser(undefined as any)).toThrow(
      "User cannot be null or undefined"
    );
  });
...
describe("processExternalData", () => {
  it("should handle library returning null", () => {
    ...
    expect(() => processExternalData(mockLib)).toThrow(
      "Library returned null data"
    );
  });
...
describe("createOrder", () => {
  ...
  it.each([
    ...
    expect(() => createOrder(data as any)).toThrow(
